...
const Card = () => {
  ...
  return (
    <>
     ...
     {filteredCards.length === 0 ? <div className="no-result-container"><p className="no-result-text">No cards found.</p> <button onClick={() => navigate("/explore") } className="explore-btn">Go to Explore</button><button onClick={() => navigate("/cardlist")} className="explore-btn">Card List</button></div> : 
